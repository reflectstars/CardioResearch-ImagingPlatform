...
QString AtrialScarClipperView::fileName;
...
void AtrialScarClipperView::ClipperImage() {
...
void AtrialScarClipperView::CtrPlanesPlacer() {
...
void AtrialScarClipperView::PickCallBack() {
...
void AtrialScarClipperView::KeyCallBackFunc(vtkObject*, long unsigned int, void* ClientData, void*) {
    ...
    AtrialScarClipperView* self;
    self = reinterpret_cast<AtrialScarClipperView*>(ClientData);
